...

{
  ...
  /*
      NOTE TO GRADER FROM JONATHAN BALDWIN
      This was Bug 1 in my report and I used gdb to debug and fix this issue. 
      I'm leaving the incorrect code commented out below so you can see it if
      needed. 
    */
  //incorrect code
